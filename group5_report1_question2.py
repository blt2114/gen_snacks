# Example to run:
# python group5_report1_question2.py fastq/2D-fail.fastq fastq/2D-pass.fastq
...
if __name__ == '__main__':
    if len(sys.argv) != 1:
        ...
        print 'To run: python group5_report1_question2.py <<.fastq files>>'
        print 'Example: \
            python group5_report1_question2.py \
